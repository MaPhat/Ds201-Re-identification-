...
class DeepSort(object):
    def __init__(
        ...
        metric4deltrack = nn_matching.NearestNeighborDistanceMetric(
            "cosine", max_cosine_distance, nn_budget
        )
    ...
    def update_tracks(self, raw_detections, camera_id, time_recorded, track_reid_cam1= None, embeds=None, frame=None, today=None, others=None, instance_masks=None):
        ...
        self.tracker.update(detections, camera_id=camera_id, time_recorded=time_recorded, today=today)
