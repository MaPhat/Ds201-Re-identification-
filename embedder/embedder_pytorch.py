...
#     "deep_sort_realtime", "embedder\weights\embedding_model.pth"
# )
...
class MobileNetv2_Embedder(object):
    ...
    def __init__(
        ...
        if model_wts_path is None:
            model_wts_path = r"embedder\weights\model_weight.pt"
        ...
        self.model.load_state_dict(torch.load(r'embedder\weights\model_weight.pt'))
    ...
    def preprocess(self, np_image):
        ...
        # input_image = torch.from_numpy(np_image_rgb.copy())
    ...
    def predict(self, np_images):
        ...
        for this_batch in batch(preproc_imgs, bs=self.max_batch_size):
            ...
            output = self.model.forward(this_batch, return_feature=True)
...
class TorchReID_Embedder(object):
    ...
    def __init__(
        ...
        if model_name=='osnet_x1_0' and model_wts_path=='':
            # model_wts_path = TORCHREID_OSNET_AIN_X1_0_MS_D_C_WTS
            model_wts_path = r"embedder\weights\osnet_x1_0_mytrained.pth"
