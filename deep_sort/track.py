...
class Track:
    ...
    def __init__(
        ...
        max_age,
        time_recorded,
        track_reid_cam1=None,
        suggested_reid=None,
        reid_consecutive=None,
        feature=None,
        original_ltwh=None,
        det_class=None,
        det_conf=None,
        ...
        if track_reid_cam1 is not None:
            self.track_reid_cam1 = track_reid_cam1
        self.suggested_reid = suggested_reid
        self.reid_consecutive = reid_consecutive
        self._n_init = n_init
    ...
    def update(self, kf, detection, time_recorded):
